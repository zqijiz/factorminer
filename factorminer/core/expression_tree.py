...
def _cs_rank(x: np.ndarray) -> np.ndarray:
    ...
    # Performance Optimization: Vectorized execution using stats.rankdata across columns
    # Replaces slower column-by-column for-loop while maintaining backward compatibility
